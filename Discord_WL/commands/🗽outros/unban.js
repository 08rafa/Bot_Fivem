...
module.exports = {
    name: "unbanfivem",
    description: "unbanfivem",
    aliases: ["unbanfivem", "unban5", "unban5m"],
    run: async (client, message, args) => {
        ...
        if (!motivo) return message.reply(`Você precisa inserir um motivo para desbanir ${id}.`)
        ...
        connection.query(sql, function (err, result) {
            ...
            let embed = new Discord.MessageEmbed()
                ...
                .setDescription(`**ID do Jogador:**  __'${id}'__\n**Motivo:** __'${motivo}'__\n**Responsável:** __'<@${message.author.id}>'__\n**ID do unban** __'${id}'__`)
